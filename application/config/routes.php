...
$route['titles']                  = 'Home/titles';
$route['specification']           = 'Home/specification';
$route['devices/access_controls'] = 'Home/access_controls';
$route['devices/tablets']         = 'Home/tablets';
$route['reservation']             = 'Home/reservation';
$route['log_book/event_logs']     = 'Home/event_logs';
$route['log_book/room_logs']      = 'Home/room_logs';
